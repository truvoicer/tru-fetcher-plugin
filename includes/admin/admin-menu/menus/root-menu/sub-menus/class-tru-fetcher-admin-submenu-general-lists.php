 ...
 */
class Tru_Fetcher_Admin_SubMenu_General_Lists extends Tru_Fetcher_Admin_Menu_Base
{
    public static string $menuSlug = "tru-fetcher-general-lists";
    ...
    public function __construct()
    {
        $this->setConfig([
            ...
            Tru_Fetcher_Admin_Menu_Constants::$pageTitleKey 	=> 'General Lists',
            Tru_Fetcher_Admin_Menu_Constants::$menuTitleKey	=> 'General Lists',
            ...
            Tru_Fetcher_Admin_Menu_Constants::$slugKey => sprintf(
                ...
                Tru_Fetcher_Admin_Post_Types::FETCHER_GENERAL_LIST_PT
            ),
            ...
            Tru_Fetcher_Admin_Menu_Constants::$postTypeKey => Tru_Fetcher_Admin_Post_Types::FETCHER_GENERAL_LIST_PT,
        ]);
    }
