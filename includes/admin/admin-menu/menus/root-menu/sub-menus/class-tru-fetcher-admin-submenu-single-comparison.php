 ...
 */
class Tru_Fetcher_Admin_SubMenu_Single_Comparison extends Tru_Fetcher_Admin_Menu_Base
{
    public static string $menuSlug = "tru-fetcher-single-comparison";

    public function __construct()
    {
        $this->setConfig([
            Tru_Fetcher_Admin_Menu_Constants::$categoryKey => 'comparisons',
            ...
            Tru_Fetcher_Admin_Menu_Constants::$pageTitleKey 	=> 'Single Comparison',
            Tru_Fetcher_Admin_Menu_Constants::$menuTitleKey	=> 'Single Comparison',
            ...
            Tru_Fetcher_Admin_Menu_Constants::$postTypeKey => Tru_Fetcher_Admin_Post_Types::FETCHER_SINGLE_COMPARISON_PT,
        ]);
    }
