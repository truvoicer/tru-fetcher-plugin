 ...
 */
class Tru_Fetcher_Admin_SubMenu_General_Item extends Tru_Fetcher_Admin_Menu_Base
{
    public static string $menuSlug = "tru-fetcher-general-item";
    ...
    public function __construct()
    {
        $this->setConfig([
            ...
            Tru_Fetcher_Admin_Menu_Constants::$pageTitleKey 	=> 'General Item',
            Tru_Fetcher_Admin_Menu_Constants::$menuTitleKey	=> 'General Item',
            ...
            Tru_Fetcher_Admin_Menu_Constants::$slugKey => sprintf(
                ...
                Tru_Fetcher_Admin_Post_Types::FETCHER_GENERAL_ITEM_PT
            ),
            ...
            Tru_Fetcher_Admin_Menu_Constants::$postTypeKey => Tru_Fetcher_Admin_Post_Types::FETCHER_GENERAL_ITEM_PT,
        ]);
    }
