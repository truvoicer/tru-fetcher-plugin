 ...
 */
class Tru_Fetcher_Admin_SubMenu_Category_Templates extends Tru_Fetcher_Admin_Menu_Base
{
    public static string $menuSlug = "tru-fetcher-category-templates";
    ...
    public function __construct()
    {
        $this->setConfig([
            ...
            Tru_Fetcher_Admin_Menu_Constants::$pageTitleKey 	=> 'Category Templates',
            Tru_Fetcher_Admin_Menu_Constants::$menuTitleKey	=> 'Category Templates',
            ...
            Tru_Fetcher_Admin_Menu_Constants::$slugKey => sprintf(
                ...
                Tru_Fetcher_Admin_Resources_Post_Types::FETCHER_CATEGORY_TEMPLATES_PT
            ),
            ...
            Tru_Fetcher_Admin_Menu_Constants::$postTypeKey => Tru_Fetcher_Admin_Resources_Post_Types::FETCHER_CATEGORY_TEMPLATES_PT,
        ]);
    }
