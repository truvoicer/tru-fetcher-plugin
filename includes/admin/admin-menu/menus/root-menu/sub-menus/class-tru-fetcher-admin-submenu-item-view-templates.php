 ...
 */
class Tru_Fetcher_Admin_SubMenu_Item_View_Templates extends Tru_Fetcher_Admin_Menu_Base
{
    public static string $menuSlug = "tru-fetcher-item-view-templates";
    ...
    public function __construct()
    {
        $this->setConfig([
            ...
            Tru_Fetcher_Admin_Menu_Constants::$pageTitleKey 	=> 'Item View Templates',
            Tru_Fetcher_Admin_Menu_Constants::$menuTitleKey	=> 'Item View Templates',
            ...
            Tru_Fetcher_Admin_Menu_Constants::$slugKey => sprintf(
                ...
                Tru_Fetcher_Admin_Resources_Post_Types::FETCHER_ITEM_VIEW_TEMPLATES_PT
            ),
            ...
            Tru_Fetcher_Admin_Menu_Constants::$postTypeKey => Tru_Fetcher_Admin_Resources_Post_Types::FETCHER_ITEM_VIEW_TEMPLATES_PT,
        ]);
    }
