 ...
 */
class Tru_Fetcher_Admin_SubMenu_Filter_Lists extends Tru_Fetcher_Admin_Menu_Base
{
    public static string $menuSlug = "tru-fetcher-filter-list";
    ...
    public function __construct()
    {
        $this->setConfig([
            ...
            Tru_Fetcher_Admin_Menu_Constants::$pageTitleKey 	=> 'Filter Lists',
            Tru_Fetcher_Admin_Menu_Constants::$menuTitleKey	=> 'Filter Lists',
            ...
            Tru_Fetcher_Admin_Menu_Constants::$slugKey => sprintf(
                ...
                Tru_Fetcher_Post_Types_Trf_Filter_List::NAME
            ),
            ...
            Tru_Fetcher_Admin_Menu_Constants::$postTypeKey => Tru_Fetcher_Post_Types_Trf_Filter_List::NAME,
        ]);
    }
