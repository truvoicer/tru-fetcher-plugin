 ...
 */
class Tru_Fetcher_Admin_SubMenu_Comparison_Lists extends Tru_Fetcher_Admin_Menu_Base
{
    public static string $menuSlug = "tru-fetcher-comparison-lists";
    ...
    public function __construct()
    {
        $this->setConfig([
            ...
            Tru_Fetcher_Admin_Menu_Constants::$pageTitleKey 	=> 'Comparison Lists',
            Tru_Fetcher_Admin_Menu_Constants::$menuTitleKey	=> 'Comparison Lists',
            ...
            Tru_Fetcher_Admin_Menu_Constants::$postTypeKey => Tru_Fetcher_Admin_Post_Types::FETCHER_COMPARISON_LIST_PT,
        ]);
    }
