...
use TruFetcher\Includes\Admin\AdminMenu\Menus\Tru_Fetcher_Admin_SubMenu_Settings;
...
{
    public static string $menuSlug = "tr-news-app";
...
//                    ],
    ...
    public function loadMenus()
    {
        $this->setConfig([
            ...
            Tru_Fetcher_Admin_Menu_Constants::$menuTitleKey => "News App",
            Tru_Fetcher_Admin_Menu_Constants::$pageTitleKey => "News App",
            Tru_Fetcher_Admin_Menu_Constants::$slugKey => "tr-news-app",
            Tru_Fetcher_Admin_Menu_Constants::$capabilityKey => "manage_options",
            Tru_Fetcher_Admin_Menu_Constants::$pageKey => 'tr-news-app-root-page',
